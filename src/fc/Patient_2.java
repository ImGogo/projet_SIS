...
public class Patient_2 {
    ...
    public Patient_2(String nom, String prenom, String dateDeNaissance, Sexe sexe, String medecinGeneraliste, String nomRue, int numeroRue, int codePostal, String ville, String pays, int compteurIpp) {
        this.nom = nom;
        this.prenom = prenom;
    ...
    public Patient_2(String nom, String prenom, String dateDeNaissance, Sexe sexe, String medecinGeneraliste, String nomRue, int numeroRue, int codePostal, String ville, String pays) {
        this.nom = nom;
        this.prenom = prenom;
        this.dateDeNaissance = dateDeNaissance;
        this.sexe = sexe;
    ...
    public Patient_2(String numeroIPP, String nom, String prenom, String dateDeNaissance, Sexe sexe, String medecinGeneraliste, String nomRue, int numeroRue, int codePostal, String ville, String pays) {
    ...
    public Patient_2(String nom, String prenom, String dateDeNaissance, Sexe sexe) {
        this.nom = nom;
        this.prenom = prenom;
        this.dateDeNaissance = dateDeNaissance;
        this.sexe = sexe;
    ...
    public Patient_2(String nom, String prenom, String dateDeNaissance, Sexe sexe, String nomRue, int numeroRue, int codePostal, String ville, String pays) {
        this.nom = nom;
        this.prenom = prenom;
        this.dateDeNaissance = dateDeNaissance;
        this.sexe = sexe;
