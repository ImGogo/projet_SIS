 ...
 * @author Go
 */
public class PopupConnexionImpossible extends javax.swing.JFrame {

    /**
     * Creates new form PopupCreationPatientReussite
     */
    public PopupConnexionImpossible() {
...
//        this.setContentPane(new RoundedPanel());
    ...
    private void initComponents() {
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(656, 169));

        jLabel1.setFont(new java.awt.Font("Ebrima", 1, 26)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(31, 58, 105));
        jLabel1.setText("Impossible de se connecter à la base de données");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupConnexionImpossible.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
