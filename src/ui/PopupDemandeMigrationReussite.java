 ...
 * @author Go
 */
public class PopupDemandeMigrationReussite extends javax.swing.JFrame {

    /**
     * Creates new form PopupCreationPatientReussite
     */
    public PopupDemandeMigrationReussite() {
...
//        this.setContentPane(new RoundedPanel());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Demande de migration envoyée");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupDemandeMigrationReussite.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
