 ...
 * @author Go
 */
public class PopupAjouterPatientUrgence extends javax.swing.JFrame {
    
    ui.creerDmaPage main = null;;
    /**
     * Creates new form PopupCreationPatientReussite
     */
    public PopupAjouterPatientUrgence() {
...
//        this.setContentPane(new RoundedPanel());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vous êtes sur le point d'ajouter un nouveau patient anonyme");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupAjouterPatientUrgence.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
