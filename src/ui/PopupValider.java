...
//        this.setContentPane(new RoundedPanel());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vous êtes sur le point d'ajouter un nouveau Dossier Patient");
        ...
        jLabel2.setText("En cas d'erreur il vous faudra contacter le service technique (0015)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopupValider.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
